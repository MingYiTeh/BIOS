 ...
 * @author kongyujian
 */
public class RoundTwoBidDAO {

    private static RoundTwoBidDAO instance = null;
     ...
     */
    public static RoundTwoBidDAO getInstance() {
        if (instance == null) {
            bidList = new ArrayList<>();
            instance = new RoundTwoBidDAO();
        }
        return instance;
    }
    ...
    /**
     * Retrieves a Bid with specified user ID, course ID and section ID from the
     * BidDAO
     *
     * @param userID User ID of the Student
     * @param courseID Course ID of the bid
     * @param sectionID Section ID of the bid
     * @return the Bid with the specified User ID, course ID and section ID,
     * null otherwise
     */
    ...
    /**
     * Retrieves the pending bid with specified user ID, course ID and section
     * ID from the BidDAO
     *
     * @param userID User ID of the Student
     * @param courseID Course ID of the bid
     * @param sectionID Section ID of the bid
     * @return the Pending Bid with specified User ID, course ID and section ID,
     * null otherwise
     */
    ...
    /**
     * Retrieves an existing bid with specified user ID, course ID and section
     * ID from the BidDAO
     *
     * @param userID User ID of the Student
     * @param courseID Course ID of the bid
     * @param sectionID Section ID of the bid
     * @return the bid with specified User ID, course ID and section ID, null
     * otherwise
     */
    ...
    /**
     * Retrieves an ArrayList of pending bids with specific course ID and
     * section ID
     *
     * @param courseID Course ID of the bid
     * @param sectionID Section ID of the bid
     * @return an ArrayList of pending bids with specific course ID and section
     * ID
     */
    ...
    /**
     * Retrieves an ArrayList of successful bids with specific course ID and
     * section ID
     *
     * @param courseID Course ID of the bid
     * @param sectionID Section ID of the bid
     * @return an ArrayList of successful bids with specific course ID and
     * section ID
     */
    ...
    /**
     * Retrieves an ArrayList of pending bids with specific user ID,course ID
     * and section ID
     *
     * @param userID User ID of the student
     * @param courseID Course ID of the bid
     * @param sectionID Section ID of the bid
     * @return an ArrayList of pending bids with specific user ID,course ID and
     * section ID
     */
    ...
    /**
     * Deletes the Bid with the specified User ID, courseID and sectionID from
     * the BidDAO
     *
     * @param userID User ID of the Student
     * @param courseID Course ID of the Bid
    ...
    /**
     * Drops the existing bidList in RoundOneBidDAO and creates a new empty
     * bidlist
     */
    public void drop() {
